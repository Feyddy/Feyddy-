...
//添加自定义AnnotationView
//以上就是自定义气泡的全部过程，但是为了在点击标注时，弹出自定义的气泡，还需要新建类CustomAnnotationView，继承MAAnnotationView或MAPinAnnotationView。若继承MAAnnotationView，则需要设置标注图标；若继承MAPinAnnotationView，使用默认的大头针标注：
